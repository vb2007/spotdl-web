...
## Corpus Check
- 89 files · ~40,474 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 656 nodes · 860 edges · 93 communities (46 shown, 47 thin omitted)
...
Cohesion: 0.07
Nodes (26): get_settings(), Settings, health(), Response, _event_stream(), Request, stream(), download_one() (+18 more)
...
Cohesion: 0.10
Nodes (19): Architecture, Auth API — `vb2007.hu-api` (verified from `/home/vb2007/code/vb2007.hu-api` source), Development environments, graphify, Locked decisions, Project: spotdl-web, Retry engine numbers, spotdl 4.5.2 — verified API surface actually used (+11 more)
...
## Knowledge Gaps
- **243 isolated node(s):** `spotdl-web-backend`, `gitignorePath`, `name`, `private`, `version` (+238 more)
...
- **Why does `Track` connect `Track` to `main.py`, `Deployment Hardening`, `Track`, `conftest.py`, `db.py`?**
  _High betweenness centrality (0.046) - this node is a cross-community bridge._
- **Why does `Base` connect `db.py` to `Track`, `Track`, `main.py`, `conftest.py`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
- **Why does `get_settings()` connect `Deployment Hardening` to `retry.py`, `proxies.py`, `events.py`, `main.py`?**
  _High betweenness centrality (0.028) - this node is a cross-community bridge._
